          ...
          <div className="flex justify-center space-x-4 text-gray-500">
            <a href="#" target="_blank" aria-label="facebook">
              <svg
                ...
                className="w-6 hover:text-primary bi bi-facebook hover:text-blue-500 ease-in duration-300"
                fill="currentColor"
            ...
            <a href="#" target="_blank" aria-label="instagram">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-6 hover:text-primary bi bi-instagram hover:text-blue-500 ease-in duration-300"
                fill="currentColor"
            ...
            <a href="#" target="_blank" aria-label="instagram">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-6 hover:text-primary bi bi-twitter hover:text-blue-500 ease-in duration-300"
                fill="currentColor"
