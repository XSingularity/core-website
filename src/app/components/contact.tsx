...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Enviar formData al servidor y procesar el correo electrónico aquí
    ...
    <div className="font-sans">
      <section className="text-gray-700 font-sans relative">
        <div className="container px-5 py-24 mx-auto">
          ...
          <img src="/c1.png" className='absolute -z-10 top-20 right-40 blur-sm w-[80px] animate-bounce-slow4' alt="" />  {/* 4 */}
            <img src="/c1.png" className='absolute -z-10 bottom-3 right-20 rotate-45 w-[100px] animate-bounce-slow5 ' alt="" />  {/*  5 */}
            <img src="/c3.png" className='absolute -z-10 top-1/2 left-20 rotate-45 w-[100px] animate-bounce-slow1 ' alt="" />  {/*  1 */}
            <img src="/c3.png" className='absolute -z-10 top-1 blur-sm left-1/2 rotate-45 w-[70px] animate-bounce-slow3 ' alt="" />  {/*  3 */}
            <img src="/c3.png" className='absolute -z-10 top-30 blur-sm left-80 rotate-180 w-[90px] animate-bounce-slow2 ' alt="" /> {/*   2  */}
