...
/** Floating WhatsApp click-to-chat button. Renders nothing until the number is configured. */
const WhatsAppButton = () => {
  ...
  return (
    <a
      ...
      className="fixed left-5 bottom-5 md:left-8 md:bottom-6 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/20 transition-all duration-300 hover:scale-110 active:scale-95 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#25D366]"
    >
