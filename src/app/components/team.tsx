...
const Team = () => {
  return (
    ...
    <img src="/c9.png" className='absolute opacity-10 -z-10 right-0 left-0 pt-[900px] m-auto w-[1100px] ' alt="" />
    {/* PLANO 3D */}
      ...
      <div className="grid gap-12 md:grid-cols-3">
        ...
        <div className="space-y-6 text-center">
          <img
            className="mx-auto h-64 w-64 rounded-full object-cover md:h-40 md:w-40 lg:h-64 lg:w-64 transition duration-300 hover:scale-[1.1] hover:shadow-sm"
            src="https://img.freepik.com/fotos-premium/retrato-hombre-negocios-sonrisa-oficina-corporativa-moderna-empresa-nueva-feliz-carrera-gerente-profesional-o-empresario-pie-brazos-cruzados-su-espacio-trabajo_590464-84927.jpg"
            alt="woman"
            loading="lazy"
            width="640"
            height="805"
